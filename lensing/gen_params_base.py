...
# This module is for generating a default set of parameters for galaxy-galaxy strong lensing with no substructure
    ...
    def run(self):
        ...
        if self.save_params == True:
            ...
            if self.save_type.lower() == 'csv':
                gen_params.params.to_csv(self.output_path + '/params_base.csv', index = False, header=True)
                
            if self.save_type.lower() == 'json':
                out_file = open(self.output_path + '/params_base.json', "w")
