...
def gen_data(parameters,
    ...
    for i in range(parameters.shape[0]):
            ...
            resolution = 100 # no of sub halos to consider
            ...
            for j in range(resolution):
                ...
                al.mp.PointMass(centre=(x_start + j*delta*math.cos(params[24]), y_start + j*delta*math.sin(params[24])), einstein_radius=(params[25]/resolution)**0.5 * params[10])
                ))
